...
const OtherCity = () => {
    ...
    <>
        <Container>
            <Row className="g-5 flex-sm-column flex-sm-wrap flex-md-row flex-lg-row my-5">
                <Col className="fixedCity">
                    {weatherDataRoma && weatherDataRoma.main && weatherDataRoma.weather && (
                        <div>
                ...
                <Col className="fixedCity">
                    {weatherDataFirenze && weatherDataFirenze.main && weatherDataFirenze.weather && (
                        <div>
                ...
                <Col className="fixedCity">
                    {weatherDataNapoli && weatherDataNapoli.main && weatherDataNapoli.weather && (
                        <div>
